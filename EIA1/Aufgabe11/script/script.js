...
function SpielerZiehtKarteVonStapel() {
    ...
    spielerDOMElement.querySelector("#uniqueID" + randomIdText).addEventListener("click", function SpielerSpielt() {
        for (var index = 0; index < spielerHand.length; index++) {
            //die geklickte Karte wird als Variable deklariert.
            var geklickteKarte = spielerHand[index];
