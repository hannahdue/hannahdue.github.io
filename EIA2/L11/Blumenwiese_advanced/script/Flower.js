...
(function (Blumenwiese_advanced) {
    class Flower {
        ...
        draw() {
            ...
            Blumenwiese_advanced.crc2.lineWidth = 4;
            Blumenwiese_advanced.crc2.strokeStyle = "#025928";
            Blumenwiese_advanced.crc2.stroke();
            //Blätter
            Blumenwiese_advanced.crc2.beginPath();
            Blumenwiese_advanced.crc2.moveTo(0, -15);
            Blumenwiese_advanced.crc2.quadraticCurveTo(-20, -25, -20, -42);
            Blumenwiese_advanced.crc2.quadraticCurveTo(-7, -38, 0, -20);
            Blumenwiese_advanced.crc2.moveTo(0, -40);
            Blumenwiese_advanced.crc2.quadraticCurveTo(10, -40, 11, -50);
            Blumenwiese_advanced.crc2.quadraticCurveTo(8, -50, 0, -45);
            Blumenwiese_advanced.crc2.closePath();
            Blumenwiese_advanced.crc2.fillStyle = "#416935";
            ...
            for (let flowerPetals = 0; flowerPetals < this.flowerPetals; flowerPetals++) {
                ...
                if (flowerPetals == this.flowerPetals - 1) {
                    ...
                    Blumenwiese_advanced.crc2.closePath();
                    Blumenwiese_advanced.crc2.fillStyle = gradientMiddle;
                    Blumenwiese_advanced.crc2.fill();
                }
            }
            //Blütenblätter Ende
        ...
        drawFlowerPetal() {
            ...
            //Farbverlauf
            let gradient = Blumenwiese_advanced.crc2.createLinearGradient(0, 0, 0, -40);
            gradient.addColorStop(0, "white");
            gradient.addColorStop(1, petalColor);
            //Blütenblatt
            Blumenwiese_advanced.crc2.beginPath();
            Blumenwiese_advanced.crc2.moveTo(0, 0);
            Blumenwiese_advanced.crc2.lineTo(-13, -20);
    ...
    Blumenwiese_advanced.Flower = Flower;
